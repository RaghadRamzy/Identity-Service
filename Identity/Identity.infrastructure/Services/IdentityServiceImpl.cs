...
namespace Identity.infrastructure.Services
{
    public class IdentityServiceImpl : IIdentityService
    {
        ...
        {
            // Previously: 1 query for users + 1 query per user for GetRolesAsync/IsLockedOutAsync (classic N+1).
            // Fixed: exactly 2 queries total, regardless of how many users there are.
        ...
        // Roles that must always exist for the system to function - never deletable.
        ...
        {
            // Previously: 1 query for roles + 1 query per role for GetClaimsAsync (N+1).
            // Fixed: exactly 2 queries total, regardless of how many roles there are.
