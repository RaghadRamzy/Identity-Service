...
namespace Identity.Application.Services
{
    ...
    public class UserService
    {
        ...
        public async Task<Result<UserDto>> CreateUserAsync(CreateUserRequest request, string temporaryPassword)
        {
            var result = await _identityService.CreateUserAsync(
                request.Username, request.FullName, request.Email, request.PhoneNumber, temporaryPassword, request.Role);
